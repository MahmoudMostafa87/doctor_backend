...
exports.getAllDoctor=async(req,res)=>{
    ...
    if(doctors.length===0||!doctors)return res.status(404).json({message:"not found"});
...
exports.addDoctor=async(req,res)=>{
    ...
    // sendEmail(req.query.email,"congrayoulation you sign up in me wep page",`
...
exports.updateNameDoctor=async(req,res)=>{
    ...
    if(!oldDoctor)return res.status(404).json({message:"not found"});
